...
Item {
    ...
    Item {
        ...
        MusicIcon {
            ...
            height: units.gu(6)
            width: height
            source: player.mute ? "qrc:/silica/images/icon-m-speaker-muted.svg" : "qrc:/silica/images/icon-m-speaker.svg"
        ...
        MusicIcon {
            ...
            anchors.verticalCenter: parent.verticalCenter
            height: units.gu(6)
            source: renderingBubble.active ? "qrc:/silica/images/icon-m-settings.svg" : "image://theme/icon-m-sounds"
            opacity: 1.0
            onClicked: {
