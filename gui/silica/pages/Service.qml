...
MusicPage {
    ...
    Loader {
        ...
        active: false
        asynchronous: true
        source: "qrc:/silica/components/ServiceEmptyState.qml"
        visible: active
    ...
    Loader {
        ...
        anchors.fill: parent
        source: "qrc:/silica/components/ServiceRegistration.qml"
        active: false
        visible: active
    ...
    Loader {
        id: loginService
        anchors.fill: parent
        source: "qrc:/silica/components/ServiceLogin.qml"
        active: false
        visible: active

        onVisibleChanged: {
            // hide the footer and toolbar to let more room for focused inputs
            if (visible) {
                showToolbar = false;
                footer.visible = false;
            } else {
