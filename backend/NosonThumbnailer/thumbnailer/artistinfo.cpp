...
ArtistInfo::ArtistInfo(DiskCacheManager* cache, NetManager* nam, AbstractAPI* api, const QString& artist, const QSize& requestedSize, bool cached, QObject* parent)
...
void ArtistInfo::run()
{
  ...
  m_p = m_api->newArtistInfo(m_artist);
  queryInfo();
}
