...
AlbumInfo::AlbumInfo(DiskCacheManager* cache, NetManager* nam, const QString& apiKey, const QString& artist, const QString& album, const QSize& requestedSize, bool cached, QObject* parent)
