...
#ifndef ARTISTARTGENERATOR_H
#define ARTISTARTGENERATOR_H
...
namespace thumbnailer
{
  ...
  namespace qml
  {
    ...
    public:
      ArtistArtGenerator(std::shared_ptr<thumbnailer::Thumbnailer> const& thumbnailer);
