...
void Sonos::addServiceOAuth(const QString& type, const QString& sn, const QString& key)
{
  SONOS::System::AddServiceOAuth(type.toUtf8().constData(), sn.toUtf8().constData(), key.toUtf8().constData());
}
